  ...
  <div class="login-container">
    <el-form ref="loginForm" :rules="rules" :model="loginForm" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-form-item prop="password">
        ...
        <el-input ref="pwd" v-model="loginForm.password" :type="showPwd" />
        <span class="svg-container" @click="isEyeShow">
          <svg-icon :icon-class="showPwd === 'password' ? 'eye' : 'eye-open'" />
        </span>
      </el-form-item>
...
export default {
  ...
  methods: {
    isEyeShow() {
      this.showPwd === 'password' ? this.showPwd = '' : this.showPwd = 'password'
      this.$nextTick(() => {
        this.$refs.pwd.focus()
      })
    },
